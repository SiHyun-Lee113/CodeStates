...
public class Implementation_Binary_Search_Tree {
    public static void main(String[] args) {
        ...
        ArrayList<Integer> test = tree.inorderTree(tree.root, 0, new ArrayList<Integer>());
        System.out.println(test.toString()); // [10, 7, 8, 12, 11]
    }
